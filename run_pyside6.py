...
from magazyn.ui.login_dialog import LoginDialog, FirstPasswordSetupDialog
...
def main() -> int:
    ...
    if not user:
        ...
        while True:
            ...
            if user:
                break
            if svc.is_password_setup_required(login):
                setup_dlg = FirstPasswordSetupDialog(login, svc, login_dialog)
                setup_dlg.exec()
